...
global T3;
LogFileName = 'ParallelResults.txt';
LogID = fopen('ParallelResults.txt', 'a');
...
fprintf(LogID, '%s: Total time for processing with %i Worker and %i of data = %.2f s\n\n', datestr(now, 0), sum(T3));
